...
class Low_Pass_Filter_Noise_amplitude_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Low_Pass_Filter_Noise_amplitude_1")
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_c(
            ...
            0, #fc
            samp_rate, #bw
            "Hydrogen Line Frequency Sink", #name
            1,
            None # parent
        )
        self.qtgui_freq_sink_x_0.set_update_time(0.10)
        self.qtgui_freq_sink_x_0.set_y_axis((-140), 140)
...
def main(top_block_cls=Low_Pass_Filter_Noise_amplitude_1, options=None):
